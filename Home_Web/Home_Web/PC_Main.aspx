<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PC_Main.aspx.cs" Inherits="Home_Web.PC_Main" %>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-auto" style="height:100px">
                      <h1 class="display-2" style="color: #FFFFFF">Home IOT PC Web System</h1>
                    </div>
                    <div class="col">
        ...
        <%--Space End --%><%--Title3 Start --%>
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-auto" style="height:100px">
                      <h1 class="display-4" style="color: #FFFFFF">Please choose a method to do</h1>
                    </div>
                    <div class="col">
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-auto" style="height:100px">
                        ...
                        <asp:LinkButton ID="LinkButton1" runat="server" Font-Size="Larger" OnClick="LinkButton1_Click">Go to mobile page</asp:LinkButton>
                    </div>
                    <div class="col">
